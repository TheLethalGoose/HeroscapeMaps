...
export const iconsAndColors: IconColorMap = {
    ...
    'SM': {id: 2, icon: 'biohazard', color: '#6f8f6f', tooltip: 'Swarm of the Marro'},
    'BU': {id: 3, icon: 'biohazard', color: '#00253f', tooltip: 'Battle for the Underdark'},
    'MV': {id: 4, icon: 'mask', color: '#440d69', tooltip: 'The Conflict Begins'},

    'RF': {id: 5, icon: 'tree', color: '#418f41', tooltip: 'Road to the Forgotten Forest'},
    'VW': {id: 6, icon: 'volcano', color: '#ff5858', tooltip: 'Volcarren Wasteland'},
